...
let userOne = new BankAccount(84343672, 'yvonne', 'Savings', 50000, 200000, 100000, 30000);
console.log(userOne);
userOne.getBalance();
userOne.open();
userOne.deposit();
...
let userTwo = new BankAccount(53456773,'Grace','current',20000,300000,4000000,250000);
console.log(userTwo);
userTwo.getBalance();
userTwo.open();
userTwo.deposit();
